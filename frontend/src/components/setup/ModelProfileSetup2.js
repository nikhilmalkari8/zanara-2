...
const ModelProfileSetup = ({
  ...
  const [profileData, setProfileData] = useState({
    ...
    unionMembership: '',
    portfolioWebsite: '',
    socialMedia: { instagram: '', tiktok: '', linkedin: '', twitter: '' },
    availability: '',
    travelWillingness: '',
    preferredLocations: [],
    workTypes: [],
           ...
           <div className="space-y-8">
             ...
             <div className="glass-effect rounded-xl p-6 transition-all duration-300 hover:border-accent-gold/30 group">
               ...
               <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                 ...
                 <div><span className="text-gray-400">Bust/Chest:</span> <span className="text-white">{profileData.bust}</span></div>
                 <div><span className="text-gray-400">Waist:</span> <span className="text-white">{profileData.waist}</span></div>
                 <div><span className="text-gray-400">Hips:</span> <span className="text-white">{profileData.hips}</span></div>
                 ...
                 <div><span className="text-gray-400">Skin Tone:</span> <span className="text-white">{profileData.skinTone}</span></div>
               </div>
             </div>
