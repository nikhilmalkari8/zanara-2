...
const RegisterCompany = ({ setCurrentPage }) => {
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button 
            ...
            style={{
              width: '100%',
              padding: '15px',
              background: isLoading ? '#666' : 'linear-gradient(45deg, #4ecdc4, #44a08d)',
              color: 'white',
              border: 'none',
              borderRadius: '8px',
              fontSize: '16px',
          ...
          >
            {isLoading ? 'Registering...' : 'Register for Hiring'}
          </button>
        </form>
        ...
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
          <p style={{ color: '#ccc' }}>
            ...
            <span 
              ...
              style={{ color: '#4ecdc4', cursor: 'pointer', textDecoration: 'underline' }}
            >
              Login here
            </span>
          </p>
          <p style={{ color: '#ccc', marginTop: '10px' }}>
            Looking to register as a model?{' '}
            <span 
        ...
        <div style={{ 
          ...
          <ul style={{ color: '#ccc', fontSize: '14px', lineHeight: '1.6', paddingLeft: '20px' }}>
            ...
            <li>Add team members and company details</li>
            <li>Post job opportunities for models</li>
            <li>Browse and connect with talented models</li>
            <li>Build your company's presence on Zanara</li>
          </ul>
        </div>
      </div>
    </div>
