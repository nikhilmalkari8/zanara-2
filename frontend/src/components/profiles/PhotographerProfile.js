...
const PhotographerProfile = ({ profileId, user, targetUser, profileData, onBack, onConnect, onMessage }) => {
  ...
  useEffect(() => {
    ...
    const createParticle = () => {
      ...
      const hue = Math.random() > 0.7 ? '#26de81' : '#ffffff';
  ...
  const fetchPhotographerProfile = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log('Experience field in received data:', data.experience);
        setProfile(data);
        setEditData(data);
      } else {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      console.log('Original editData:', editData);
      
      let dataToSend = { ...editData };
      
      console.log('Data being sent to API:', dataToSend);
      console.log('Transformed experience:', dataToSend.experience);
      ...
      if (response.ok) {
        console.log('Response was OK, fetching updated profile...');
  ...
  // In the PhotographerProfile component, add dropzone logic:
  ...
  const getProfileCompletion = (profile) => {
    const requiredFields = [
      ...
      { key: 'photographyTypes', label: 'Photography Types' },
    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{
        ...
        .luxury-background::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(circle at 25% 25%, rgba(38, 222, 129, 0.05) 0%, transparent 50%),
        ...
        .luxury-background::after {
          ...
          width: 300px;
          height: 300px;
          background: radial-gradient(circle, rgba(38, 222, 129, 0.03) 0%, transparent 70%);
          border-radius: 50%;
          filter: blur(40px);
        }
        ...
        .luxury-button-primary:hover {
          ...
          box-shadow: 0 8px 30px rgba(38, 222, 129, 0.4);
        }
        ...
        .luxury-cover {
          ...
          overflow: hidden;
          position: relative;
          background: linear-gradient(135deg, rgba(38, 222, 129, 0.1) 0%, rgba(0, 0, 0, 0.3) 100%);
        }
        ...
        .luxury-profile-details h1 {
          ...
          background: linear-gradient(135deg, #ffffff 0%, #26de81 100%);
                  ...
                  <>
                    {isEditing ? (
                      <>
                        <button 
                          ...
                          onClick={() => {
                            ...
                            console.log('Experience in editData:', editData.experience);
                            handleSaveChanges();
                          }}
                          disabled={uploading}
                        >
                        ...
                        <button 
                          ...
                          onClick={() => {
                            setIsEditing(false);
                            setEditData(profile); // Reset to original profile data
                          }}
                        >
                          <X className="w-4 h-4" />
                          Cancel
                      ...
                      <button 
                        ...
                        onClick={() => {
                          setIsEditing(true);
                          // Ensure editData is properly initialized with current profile
                          setEditData({
                            ...profile,
                            experience: ensureExperienceArray(profile?.experience)
                          });
                        }}
                      >
              ...
              <div className="luxury-cover">
                {currentProfile?.coverPhoto ? (
                  ...
                  <div style={{ 
                    width: '100%', 
                    height: '100%', 
                    background: 'linear-gradient(135deg, rgba(38, 222, 129, 0.2) 0%, rgba(0, 0, 0, 0.8) 100%)',
                    display: 'flex',
                    alignItems: 'center',
                ...
                {isEditing && (
                  <div style={{
                    ...
                    <input
                      ...
                      disabled={uploading}
                    />
                    <label htmlFor="profilePicture" style={{ cursor: 'pointer', color: '#26de81' }}>
                  ...
                  <div className="luxury-profile-details">
                    {isEditing ? (
                      ...
                      <>
                        ...
                        <div className="headline">{currentProfile?.headline || 'Professional Photography Services'}</div>
          ...
          <div className="luxury-grid">
              ...
              <div className="luxury-card" style={{ '--delay': '0.6s' }}>
                ...
                {isEditing ? (
                  <textarea
                    ...
                    placeholder="Describe your photography style, experience, and what makes you unique as a photographer..."
                    rows={6}
                  />
                ) : (
                  <p style={{ 
                    ...
                    {currentProfile?.bio || 'Professional photographer with expertise in creating stunning visual stories. Passionate about capturing authentic moments and bringing creative visions to life through exceptional photography.'}
                  </p>
                )}
              </div>
                    ...
                    <div style={{ display: 'flex', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '12px', padding: '4px' }}>
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: '8px',
                          border: 'none',
                          background: portfolioFilter === 'all' ? '#26de81' : 'transparent',
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: '8px',
                          border: 'none',
                          background: portfolioFilter === 'photos' ? '#26de81' : 'transparent',
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: '8px',
                          border: 'none',
                          background: portfolioFilter === 'videos' ? '#26de81' : 'transparent',
                ...
                {displayPortfolio && displayPortfolio.length > 0 ? (
                                ...
                                {(provided, snapshot) => (
                                  <div
                                    ...
                                    style={{
                                      ...
                                      boxShadow: snapshot.isDragging ? '0 8px 30px #26de81' : undefined,
                                      border: snapshot.isDragging ? '2px solid #26de81' : undefined
                                    }}
                                    onClick={() => {
                  ...
                  <div className="luxury-empty-state">
                    ...
                    <div className="luxury-empty-description">
                      {isEditing ? "Upload photos and videos to showcase your photography work" : "This photographer hasn't uploaded any portfolio media yet"}
                    </div>
                    {isEditing && (
                  ...
                  <>
                    {ensureExperienceArray(currentProfile?.experience).length > 0 ? (
                      ...
                      <div className="luxury-empty-state">
                        ...
                        <div className="luxury-empty-description">
                          {isEditing ? "Add your photography experience and projects" : "No photography experience has been added yet"}
                        </div>
                      </div>
                    )}
                  </>
            ...
            <div className="luxury-sidebar">
              ...
              <div className="luxury-card" style={{ '--delay': '0.7s' }}>
                ...
                {isEditing ? (
                  <textarea
                    value={(editData.photographyTypes || []).join(', ')}
                    onChange={(e) => handleArrayInputChange('photographyTypes', e.target.value)}
                    className="luxury-textarea"
                    placeholder="Fashion, Portrait, Commercial, Event, Wedding, Product (comma separated)"
                    rows={4}
                  />
                ) : (
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                    {(currentProfile?.photographyTypes && currentProfile.photographyTypes.length > 0
                      ? currentProfile.photographyTypes 
                      : ['Portrait Photography', 'Event Photography']).map((type, index) => (
              ...
              <div className="luxury-card" style={{ '--delay': '0.9s' }}>
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <textarea
                      value={(editData.cameraEquipment || []).join(', ')}
                      onChange={(e) => handleArrayInputChange('cameraEquipment', e.target.value)}
                      className="luxury-textarea"
                      placeholder="Camera equipment (comma separated)"
                      rows={2}
                    />
                    <textarea
                      value={(editData.lensCollection || []).join(', ')}
                      onChange={(e) => handleArrayInputChange('lensCollection', e.target.value)}
                      className="luxury-textarea"
                      placeholder="Lens collection (comma separated)"
                      rows={2}
                    />
                    <textarea
                      value={(editData.lightingEquipment || []).join(', ')}
                      onChange={(e) => handleArrayInputChange('lightingEquipment', e.target.value)}
                      className="luxury-textarea"
                      placeholder="Lighting equipment (comma separated)"
                      rows={2}
                    />
                  </div>
                ) : (
                  <>
                    {(currentProfile?.cameraEquipment || currentProfile?.lensCollection || currentProfile?.lightingEquipment) ? (
                      <div style={{ color: 'rgba(255, 255, 255, 0.8)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {currentProfile?.cameraEquipment && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Cameras:</span>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.25rem' }}>
                              {ensureArray(currentProfile.cameraEquipment).map((item, index) => (
                                <div key={index} className="luxury-skill-item" style={{ margin: '0.25rem' }}>
                                  {item}
                                </div>
                              ))}
                            </div>
                        ...
                        {currentProfile?.lensCollection && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Lenses:</span>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.25rem' }}>
                              {ensureArray(currentProfile.lensCollection).map((item, index) => (
                                <div key={index} className="luxury-skill-item" style={{ margin: '0.25rem' }}>
                                  {item}
                                </div>
                              ))}
                        ...
                        {currentProfile?.lightingEquipment && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Lighting:</span>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.25rem' }}>
                              {ensureArray(currentProfile.lightingEquipment).map((item, index) => (
                                <div key={index} className="luxury-skill-item" style={{ margin: '0.25rem' }}>
                                  {item}
                                </div>
                              ))}
                      ...
                      <div className="luxury-empty-state">
                        <div className="luxury-empty-icon">📷</div>
                        <div className="luxury-empty-title">No Equipment Listed</div>
                        <div className="luxury-empty-description">Photography equipment details not provided</div>
                      </div>
                    )}
                  </>
                )}
              ...
              <div className="luxury-card" style={{ '--delay': '1.1s' }}>
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <input
                      type="text"
                      value={editData.rates?.portraitSession || ''}
                      onChange={(e) => handleInputChange('rates.portraitSession', e.target.value)}
                      className="luxury-form-input"
                      placeholder="Portrait Session Rate (e.g., $300)"
                    />
                    <input
                      type="text"
                      value={editData.rates?.eventHourly || ''}
                      onChange={(e) => handleInputChange('rates.eventHourly', e.target.value)}
                      className="luxury-form-input"
                      placeholder="Event Hourly Rate (e.g., $150/hour)"
                    />
                    <input
                      type="text"
                      value={editData.rates?.commercialDay || ''}
                      onChange={(e) => handleInputChange('rates.commercialDay', e.target.value)}
                      className="luxury-form-input"
                      placeholder="Commercial Day Rate (e.g., $1500/day)"
                    />
                    <select
                  ...
                  <>
                    {(currentProfile?.rates && (currentProfile.rates.portraitSession || currentProfile.rates.eventHourly || currentProfile.rates.commercialDay)) || 
                     currentProfile?.availability ? (
                      <div style={{ color: 'rgba(255, 255, 255, 0.8)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {currentProfile?.rates?.portraitSession && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Portrait Session:</span>
                            <span style={{ color: '#26de81' }}>{currentProfile.rates.currency || '$'}{currentProfile.rates.portraitSession}</span>
                          </div>
                        )}
                        {currentProfile?.rates?.eventHourly && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Event Hourly:</span>
                            <span style={{ color: '#26de81' }}>{currentProfile.rates.currency || '$'}{currentProfile.rates.eventHourly}</span>
                          </div>
                        )}
                        {currentProfile?.rates?.commercialDay && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Commercial Day:</span>
                            <span style={{ color: '#26de81' }}>{currentProfile.rates.currency || '$'}{currentProfile.rates.commercialDay}</span>
                          </div>
                        )}
                        {currentProfile?.availability && (
                        ...
                        {(currentProfile?.travelRadius === 'international' || currentProfile?.mobileServices) && (
                          <div style={{ color: '#22c55e', fontSize: '0.9rem' }}>
                            <Globe className="w-4 h-4 mr-2" style={{ display: 'inline' }} />
                            Available for travel/mobile services
                          </div>
                        )}
                      </div>
                    ) : (
              ...
              <div className="luxury-card" style={{ '--delay': '1.3s' }}>
                ...
                {isEditing ? (
                  ...
                  <>
                    {(currentProfile?.yearsExperience || currentProfile?.educationBackground || currentProfile?.certifications || currentProfile?.awards) ? (
                      <div style={{ color: 'rgba(255, 255, 255, 0.8)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {currentProfile?.yearsExperience && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Experience:</span>
                            <span>{currentProfile.yearsExperience}</span>
                          </div>
                        )}
                        {currentProfile?.educationBackground && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500' }}>Education:</span>
                        ...
                        {currentProfile?.certifications && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500' }}>Certifications:</span>
                            <div style={{ marginTop: '0.25rem' }}>
                              {currentProfile.certifications}
                            </div>
                          </div>
                        ...
                        {currentProfile?.awards && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500' }}>Awards:</span>
                            <div style={{ marginTop: '0.25rem' }}>
                              {currentProfile.awards}
                            </div>
                          </div>
                      ...
                      <div className="luxury-empty-state">
                        <div className="luxury-empty-icon">🎓</div>
                        <div className="luxury-empty-title">No Background Info</div>
                        <div className="luxury-empty-description">Professional background details haven't been provided</div>
                      </div>
                    )}
                  </>
                )}
                    ...
                    <>
                      ...
                      {currentProfile?.portfolioWebsite && (
                        ...
                        >
                          ...
                          <div style={{ color: '#26de81' }}>Portfolio Website</div>
                        </a>
                      )}
              ...
              <div className="luxury-card" style={{ '--delay': '1.7s' }}>
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    ...
                    <input
                      type="text"
                      value={editData.behancePortfolio || ''}
                  ...
                  <>
                    {(currentProfile?.socialMedia && Object.values(currentProfile.socialMedia).some(val => val)) || 
                     currentProfile?.behancePortfolio || currentProfile?.linkedinProfile ? (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        {currentProfile?.behancePortfolio && (
                          <a
                            href={currentProfile.behancePortfolio}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="luxury-social-link"
                          >
                            <Globe className="w-4 h-4" style={{ color: '#1769ff' }} />
                            <span>Behance</span>
                          </a>
                        )}
                        {currentProfile?.linkedinProfile && (
                          <a
                            href={currentProfile.linkedinProfile}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="luxury-social-link"
                          >
              ...
              <div className="luxury-card" style={{ '--delay': '1.9s' }}>
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    {['Weddings', 'Portraits', 'Corporate Events', 'Fashion Shoots', 'Product Photography', 'Real Estate', 'Sports Events'].map(option => (
                      <label key={option} style={{ color: 'white', fontSize: '0.95rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <input
                          type="checkbox"
                          checked={Array.isArray(editData.preferredProjectTypes) && editData.preferredProjectTypes.includes(option)}
                          onChange={e => {
                            const checked = e.target.checked;
                            setEditData(prev => {
                              const arr = Array.isArray(prev.preferredProjectTypes) ? [...prev.preferredProjectTypes] : [];
                              if (checked && !arr.includes(option)) arr.push(option);
                              if (!checked && arr.includes(option)) arr.splice(arr.indexOf(option), 1);
                              return { ...prev, preferredProjectTypes: arr };
                            });
                          }}
                        />
                        {option}
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                    {(currentProfile?.preferredProjectTypes && currentProfile.preferredProjectTypes.length > 0
                      ? currentProfile.preferredProjectTypes
                      : ['Portrait Photography']).map((option, idx) => (
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <textarea
                      ...
                      className="luxury-textarea"
                      placeholder="Wedding, Fashion, Portrait, Commercial, Product (comma separated)"
                      rows={3}
                    />
                    <textarea
                      value={(editData.shootingStyles || []).join(', ')}
                      onChange={(e) => handleArrayInputChange('shootingStyles', e.target.value)}
                      className="luxury-textarea"
                      placeholder="Natural Light, Studio, Outdoor, Editorial, Street (comma separated)"
                      rows={3}
                    />
                  </div>
                ) : (
                  <>
                    {(currentProfile?.specializations?.length || currentProfile?.shootingStyles?.length) ? (
                      <div style={{ color: 'rgba(255, 255, 255, 0.8)', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        {currentProfile?.specializations?.length > 0 && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Specializations:</span>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                        ...
                        {currentProfile?.shootingStyles?.length > 0 && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Shooting Styles:</span>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                              {currentProfile.shootingStyles.map((style, index) => (
                                <div key={index} className="luxury-badge">
                      ...
                      <div className="luxury-empty-state">
                        <div className="luxury-empty-icon">🎯</div>
                        <div className="luxury-empty-title">No Specializations Listed</div>
                        <div className="luxury-empty-description">Photography specializations and styles not specified</div>
                      </div>
                    )}
                  </>
                )}
              ...
              <div className="luxury-card" style={{ '--delay': '2.3s' }}>
                <div className="luxury-card-header">
                  <h2 className="luxury-card-title">
                    🏆 Professional Credentials
                  </h2>
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <textarea
                      ...
                      className="luxury-textarea"
                      placeholder="Adobe Certified Expert, PPA Certified, etc. (comma separated)"
                      rows={3}
                    />
                    <textarea
                      ...
                      className="luxury-textarea"
                      placeholder="Photography degree, training, workshops..."
                      rows={3}
                    />
                  </div>
                ) : (
                  <>
                    {(currentProfile?.certifications?.length || currentProfile?.education) ? (
                      <div style={{ color: 'rgba(255, 255, 255, 0.8)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {currentProfile?.certifications?.length > 0 && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Certifications:</span>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.25rem' }}>
                      ...
                      <div className="luxury-empty-state">
                        <div className="luxury-empty-icon">🏆</div>
                        <div className="luxury-empty-title">No Credentials Listed</div>
                        <div className="luxury-empty-description">Professional credentials not provided</div>
                      </div>
                    )}
                  </>
                )}
              ...
              <div className="luxury-card" style={{ '--delay': '2.5s' }}>
                <div className="luxury-card-header">
                  <h2 className="luxury-card-title">
                    📋 Project Details
                  </h2>
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <select
                      value={editData.typicalProjectDuration || ''}
                      onChange={(e) => handleInputChange('typicalProjectDuration', e.target.value)}
                      className="luxury-form-input"
                    >
                      <option value="">Typical Project Duration</option>
                      <option value="half-day">Half Day</option>
                      <option value="full-day">Full Day</option>
                      <option value="multi-day">Multi-Day</option>
                      <option value="weekly">Weekly Projects</option>
                      <option value="flexible">Flexible</option>
                    </select>
                    <textarea
                      value={(editData.teamCollaboration || []).join(', ')}
                      onChange={(e) => handleArrayInputChange('teamCollaboration', e.target.value)}
                      className="luxury-textarea"
                      placeholder="Makeup artists, Stylists, Creative directors (comma separated)"
                      rows={2}
                    />
                    <input
                      type="number"
                      value={editData.deliverables?.editedPhotos || ''}
                      onChange={(e) => handleInputChange('deliverables.editedPhotos', parseInt(e.target.value))}
                      className="luxury-form-input"
                      placeholder="Number of edited photos included"
                    />
                    <input
                      type="text"
                      value={editData.deliverables?.turnaroundTime || ''}
                      onChange={(e) => handleInputChange('deliverables.turnaroundTime', e.target.value)}
                      className="luxury-form-input"
                      placeholder="Turnaround time (e.g., 3-5 business days)"
                    />
                    <label style={{ color: 'white', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      <input
                        type="checkbox"
                        checked={editData.deliverables?.rawFiles || false}
                  ...
                  <>
                    {(currentProfile?.typicalProjectDuration || currentProfile?.teamCollaboration?.length || currentProfile?.deliverables) ? (
                      <div style={{ color: 'rgba(255, 255, 255, 0.8)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {currentProfile?.typicalProjectDuration && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Project Duration:</span>
                            <span>{currentProfile.typicalProjectDuration.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}</span>
                          </div>
                        )}
                        {currentProfile?.teamCollaboration?.length > 0 && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Team Collaboration:</span>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.25rem' }}>
                              {currentProfile.teamCollaboration.map((collab, index) => (
                                <div key={index} className="luxury-skill-item" style={{ margin: '0.25rem' }}>
                                  🤝 {collab}
                                </div>
                              ))}
                        ...
                        {currentProfile?.deliverables && (
                          <div>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>Deliverables:</span>
                            {currentProfile.deliverables.editedPhotos && (
                              <div style={{ marginBottom: '0.25rem' }}>📸 {currentProfile.deliverables.editedPhotos} edited photos included</div>
                            )}
                            {currentProfile.deliverables.turnaroundTime && (
                              <div style={{ marginBottom: '0.25rem' }}>⏱️ {currentProfile.deliverables.turnaroundTime}</div>
                            )}
                            {currentProfile.deliverables.rawFiles && (
                              <div style={{ color: '#26de81' }}>✓ Raw files provided</div>
                            )}
                          </div>
                        )}
                      </div>
                      ...
                      <div className="luxury-empty-state">
                        <div className="luxury-empty-icon">📋</div>
                        <div className="luxury-empty-title">No Project Details</div>
                        <div className="luxury-empty-description">Project details and deliverables not specified</div>
                      </div>
                    )}
                  </>
                )}
              ...
              {/* Enhanced Booking & Availability */}
              <div className="luxury-card" style={{ '--delay': '2.7s' }}>
                <div className="luxury-card-header">
                  <h2 className="luxury-card-title">
                ...
                {isEditing ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <input
                      type="text"
                      value={editData.bookingLeadTime || ''}
                      onChange={(e) => handleInputChange('bookingLeadTime', e.target.value)}
                      className="luxury-form-input"
                      placeholder="Booking lead time (e.g., 2 weeks notice preferred)"
                    />
                    <select
                      value={editData.travelWillingness || ''}
                      onChange={(e) => handleInputChange('travelWillingness', e.target.value)}
                      className="luxury-form-input"
                    >
                      <option value="">Travel Willingness</option>
                    ...
                    <label style={{ color: 'white', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      <input
                        type="checkbox"
                        checked={editData.weekendAvailability || false}
                  ...
                  <>
                    {(currentProfile?.bookingLeadTime || currentProfile?.travelWillingness || currentProfile?.weekendAvailability !== undefined) ? (
                      <div style={{ color: 'rgba(255, 255, 255, 0.8)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {currentProfile?.bookingLeadTime && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Lead Time:</span>
                            <span>{currentProfile.bookingLeadTime}</span>
                          </div>
                        )}
                        {currentProfile?.travelWillingness && (
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Travel:</span>
                            <span>{currentProfile.travelWillingness.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}</span>
                          </div>
                        )}
                        {currentProfile?.weekendAvailability && (
                          <div style={{ color: '#26de81' }}>
                            ✓ Available for weekend shoots
                          </div>
                        )}
                      </div>
                      ...
                      <div className="luxury-empty-state">
                        <div className="luxury-empty-icon">📅</div>
                        <div className="luxury-empty-title">No Booking Info</div>
                        <div className="luxury-empty-description">Booking preferences not specified</div>
                      </div>
                    )}
                  </>
                )}
      ...
      {uploading && uploadProgress > 0 && uploadProgress < 100 && (
        <div style={{ width: '100%', maxWidth: 400, margin: '1rem auto' }}>
          <div style={{ height: 8, background: 'rgba(255,255,255,0.08)', borderRadius: 8, overflow: 'hidden' }}>
            <div style={{ width: `${uploadProgress}%`, height: '100%', background: 'linear-gradient(90deg,#26de81,#20bf6b)', borderRadius: 8, transition: 'width 0.3s' }} />
          </div>
          <div style={{ color: '#26de81', fontSize: '0.95rem', marginTop: 4, textAlign: 'center' }}>{uploadProgress}%</div>
        </div>
      )}
    </>
  );
